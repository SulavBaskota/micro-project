...
export const fetchPendingOrders = createAsyncThunk(
    'pendingOrders/fetchPendingOrders', async () => {
        const options = {
            method: 'GET',
            headers: {
...
export const markCompleted = createAsyncThunk(
    'pendingOrders/markCompleted', async orderInfo => {
        const options = {
            method: 'POST',
            headers: {
                'content-type': 'application/json',
    ...
    extraReducers(builder) {
        builder
            ...
            .addCase(markCompleted.fulfilled, (state, action) => {
                ...
                return {
                    ...state,
                    pendingOrdersList: state.pendingOrdersList.filter(order =>
...
export const selectPendingOrders = state => state.pendingOrders.pendingOrdersList

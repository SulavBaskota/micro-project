  ...
  return (
    ...
    >
      ...
      <TableCell align="right">
        <List>{order.items.map((item) => subItem(item.itemInfo.name))}</List>
      </TableCell>
      <TableCell align="right">
        <List>{order.items.map((item) => subItem(item.quantity))}</List>
      </TableCell>
      <TableCell align="right">
        <List>{order.items.map((item) => subItem(item.itemInfo.price))}</List>
      </TableCell>
      <TableCell align="right">
        <List>
